...
class WeatherService {
  ...
  ///
  /// The city is given as a parameter.
  ///
  /// Returns a [CurrentWeatherData] object if the request is successful.
  /// Otherwise, throws an exception.
  Future<CurrentWeatherData?> fetchCurrentWeather(String city) async {
  ...
  /// Otherwise, throws an exception.
  Future<FiveDaysData?> fetchFiveDaysForecast(String city) async {
